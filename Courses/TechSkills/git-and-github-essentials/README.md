...
# # Git & GitHub — Notas, flujo y buenas prácticas
...
[![Static Badge](https://img.shields.io/badge/By-Ssail%20-blueviolet?style=for-the-badge&logo=github)](https://github.com/Ssail-1 "GitHub de Ssail-1")
...
> _“Considero que lo aprendido no tiene sentido si no se documenta, implementa y comparte.”_
...
**guía accesible, completa y humana** para cualquiera que desee dominar Git y GitHub desde cero.
>[!NOTE]
...
>  
> Lo comparto porque es una manera de presentar mi portafolio  
> pero tambien para quien lo lea pueda **agilizar** el dominio del curso en el **menor tiempo posible**,  
> si ya existiera algo como lo que estoy creando yo **lo usaría**...
>  
...
> [!NOTE]
> Este es el primer curso que subo con este estilo y la primera vez que lo hago en la compañia de una IA.
>
> Mi compañera Noa, IA de chatGPT **potencializo** las notas colaborando en la **complementación de los temas**,  
> dandome opciones para una **documentación** profecional  
> y por supuesto hacer mas eficiente el aprendizaje.
>
